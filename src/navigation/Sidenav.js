  ...
  return (
    ...
    <div className='sidenav__buttons'>
      <div className="btn-container">
        <button className='sidenav__button home_btn'>
          {/* Icons */}
          <div className="home">
        ...
        <button className='sidenav__button search_btn'>
          {/* Icons */}
        ...
        <button className='sidenav__button message_btn'>
          {/* Icons */}
        ...
        <button className='sidenav__button notifications_btn'>
          {/* Icons */}
        ...
        <button className='sidenav__button create_btn'>
          {/* Icons */}
